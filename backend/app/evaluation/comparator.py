...
class ForecastComparator:
    ...
    def compare(model_name: str, impact: EntityImpact, actual_return: float) -> PredictionRecord:
        return PredictionRecord(
            ...
            predicted_return=impact.expected_return,
            actual_return=actual_return,
            direction_probability=impact.direction_probability,
            predicted_direction=impact.direction.value,
            return_range=impact.return_range,
            horizon_days=impact.time_horizon_days,
        )
